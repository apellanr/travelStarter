        ...
        return (
            <div className={`jumbotron city-jumbo ${this.props.className}`}>
                <div className="jumbo-content">
                    ...
                    <p className={location === '/discover' ? 'hide' : 'lead text-center'} id={`${this.props.id}`}>travelStarter is a place where you can discover past trips or build your own trip from scratch.</p>
                    <p className="lead">
